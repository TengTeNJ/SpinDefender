          ...
          children: [
            ...
            Container(
                ...
                child:Column(
                  ...
                  children: [
                    Constants.mediumWhiteTextWidget("Training History", 16, Colors.white),
                    SizedBox(height: 18,),

                    /// 总共的训练时间
                    Container(
                      margin: EdgeInsets.only(left: 16),
                      child: TrainingDataView(model: MonthDataModel("Total", "10:20:33", "+2%"),),
                    ),
                    ...
                    Container(
                      margin: EdgeInsets.only(left: 16),
                      child: TrainingDataView(model: MonthDataModel("Avg. Time", "00:40:30", "+2%"),),
                    ),
                    ...
                    Container(
                      margin: EdgeInsets.only(left: 16),
                      child: TrainingDataView(model: MonthDataModel("Latest Training", "00:35:01", "02.10.2025"),),
                    ),
                    SizedBox(height: 26,),
                  ],
                )
